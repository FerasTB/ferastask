...
@section('content')
    <form class="content" action="/drug/{{ $drug->id }}" method="POST">
        @method('PUT')
        @csrf
        <div class="form-group">
            <label for="exampleInputPassword1">Drug Name</label>
            <input type="text" class="form-control" id="exampleInputPassword1" value="{{ $drug->genericName }}"
                name="genericName">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" value="{{ $drug->tradeName }}"
                name="tradeName">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" value="{{ $drug->note }}"
                name="note">
            @if ($errors->has('note'))

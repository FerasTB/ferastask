...
@section('content')
    <form class="content" action="/test-manage/{{ $test->id }}" method="POST">
        @method('PUT')
        @csrf
        <div class="form-group">
            <label for="exampleInputPassword1">Test Name</label>
            <input type="text" class="form-control" id="exampleInputPassword1" value="{{ $test->testName }}" name="testName">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputEmail1" "
                                    value="{{ $test->comment }}" name="comment">
